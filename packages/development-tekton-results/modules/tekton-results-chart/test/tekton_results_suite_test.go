...
var (
	...
	kindClusterName = "kind-tekton-results-test"
)

// TestTektonResultsSuite bootstraps tekton-results terraform module test, with Terratest.
func TestTektonResultsSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Tekton Results suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy tekton-results
