...
var (
	...
	kindClusterName = "atlas-operator-test"
)

// TestAtlasOperatorSuite bootstraps atlas-operator terraform module test, with Terratest.
func TestAtlasOperatorSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "AtlasOperator suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy atlas-operator
