...
var (
	...
	kindClusterName = "kind-argo-events-test"
)

// TestArgoEventsSuite bootstraps argo-events terraform module test, with Terratest.
func TestArgoEventsSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Argo Events Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy argo-events
