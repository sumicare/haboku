...
var (
	...
	kindClusterName = "kind-dex-test"
)

// TestDexSuite bootstraps dex terraform module test, with Terratest.
func TestDexSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Dex suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy dex
