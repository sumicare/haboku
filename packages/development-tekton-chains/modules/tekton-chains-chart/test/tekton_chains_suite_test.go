...
var (
	...
	kindClusterName = "kind-tekton-chains-test"
)

// TestTektonChainsSuite bootstraps tekton-chains terraform module test, with Terratest.
func TestTektonChainsSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Tekton Chains suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy tekton-chains
