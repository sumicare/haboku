...
var (
	...
	kindClusterName = "kind-tekton-pipeline-test"
)

// TestTektonPipelineSuite bootstraps tekton-pipeline terraform module test, with Terratest.
func TestTektonPipelineSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Tekton Pipeline suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy tekton-pipeline
