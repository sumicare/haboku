...
var (
	...
	kindClusterName = "kind-theia-test"
)

// TestTheiaSuite bootstraps theia terraform module test, with Terratest.
func TestTheiaSuite(t *testing.T) {
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy theia
