...
var (
	...
	kindClusterName = "kind-argo-rollouts-test"
)

// TestArgoRolloutsSuite bootstraps argo-rollouts terraform module test, with Terratest.
func TestArgoRolloutsSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ArgoRollouts Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy argo-rollouts
