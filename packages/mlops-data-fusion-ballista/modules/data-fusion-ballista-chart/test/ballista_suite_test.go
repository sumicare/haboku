...
var (
	...
	kindClusterName = "kind-datafusion-ballista-test"
)

// TestDataFusionBallistaSuite bootstraps datafusion-ballista terraform module test, with Terratest.
func TestDataFusionBallistaSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Apache DataFusion Ballista Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy datafusion-ballista
