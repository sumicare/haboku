...
var (
	...
	//nolint:gochecknoglobals // test suite state
	kindClusterName = "cert-manager-test"
)

// TestCertManagerSuite bootstraps cert-manager terraform module test, with Terratest.
func TestCertManagerSuite(t *testing.T) {
	RegisterFailHandler(Fail)


	RunSpecs(t, "CertManager Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy cert-manager
	GinkgoT().Logf("Deploying cert-manager to cluster...")
