...
var (
	...
	kindClusterName = "kind-tekton-trigger-test"
)

// TestTektonTriggerSuite bootstraps tekton-trigger terraform module test, with Terratest.
func TestTektonTriggerSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Tekton Trigger suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy tekton-trigger
