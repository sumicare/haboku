...
var (
	...
	//nolint:gochecknoglobals // test suite state
	kindClusterName = "velero-test"
)

// TestVeleroSuite bootstraps velero terraform module test, with Terratest.
func TestVeleroSuite(t *testing.T) {
	RegisterFailHandler(Fail)


	RunSpecs(t, "Velero Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy velero
	GinkgoT().Logf("Deploying velero to cluster...")
