...
var (
	...
	kindClusterName = "kind-kube-ray-test"
)

// TestArgoEventsSuite bootstraps kube-ray terraform module test, with Terratest.
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy kube-ray
