...
var (
	...
	kindClusterName = "kind-tekton-dashboard-test"
)

// TestTektonDashboardSuite bootstraps tekton-dashboard terraform module test, with Terratest.
func TestTektonDashboardSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Tekton Dashboard suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy tekton-dashboard
