...
Haboku forms the expressive foundation upon which the ikebana-inspired components of the Kachō ecosystem ([Rikka](https://github.com/sumicare/rikka), [Shōka](https://github.com/sumicare/shoka), [Moribana](https://github.com/sumicare/moribana), etc.) harmoniously arrange cluster resources.
